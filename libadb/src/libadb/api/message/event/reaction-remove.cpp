#include <libadb/api/message/event/reaction-remove.hpp>
#include <libadb/types/helpers/json-optional.hpp>
#include <nlohmann/json.hpp>
using namespace adb::api;
using namespace adb::types;

void adb::api::to_json(nlohmann::json& j, const MessageReactionRemove& reactionAdd)
{
    j = nlohmann::json
    {
...
void adb::api::from_json(const nlohmann::json& j, MessageReactionRemove& reactionAdd)
{
